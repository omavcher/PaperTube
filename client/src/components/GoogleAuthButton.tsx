...
const handleGoogleSuccess = async (response: { access_token: string; }) => {
  ...
  return (
    <button
      onClick={() => googleLogin()}
      className={`flex items-center justify-center gap-3 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-sm ${className}`}
    >
