        ...
        <div className="mt-24 space-y-16 px-4">
          <div className="text-center space-y-6 max-w-3xl mx-auto">
            ...
            <p className="text-neutral-400 font-medium leading-relaxed">
              Paperxify provides the fastest way to extract pages from your PDF documents without relying on cloud servers. We guarantee complete privacy.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="p-6 rounded-2xl bg-neutral-900/40 border border-white/5 space-y-4">
              ...
              <p className="text-sm text-neutral-400">100% client-side processing.</p>
            </div>
            <div className="p-6 rounded-2xl bg-neutral-900/40 border border-white/5 space-y-4">
              <div className="h-12 w-12 rounded-full bg-red-600/10 flex items-center justify-center border border-red-600/20">
                <span className="text-red-500 font-bold">2</span>
              </div>
              <h3 className="text-xl font-bold text-white">No Limits</h3>
              <p className="text-sm text-neutral-400">Extract as many pages as you want.</p>
            </div>
            <div className="p-6 rounded-2xl bg-neutral-900/40 border border-white/5 space-y-4">
              <div className="h-12 w-12 rounded-full bg-red-600/10 flex items-center justify-center border border-red-600/20">
              ...
              <p className="text-sm text-neutral-400">Instant processing without waiting for uploads.</p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-8 mt-16 p-8 rounded-3xl bg-neutral-900/20 border border-white/10">
            ...
            <div className="space-y-6">
              <div>
                <h4 className="text-lg font-bold text-white mb-2">How do I split a PDF file?</h4>
                <p className="text-neutral-400">Upload your PDF file, select the pages you want to extract, or define custom ranges. Click 'Split PDF' to instantly download your separated files.</p>
              </div>
              <div className="w-full h-px bg-white/5"></div>
              <div>
                <h4 className="text-lg font-bold text-white mb-2">Is it safe to split PDFs here?</h4>
                <p className="text-neutral-400">Yes, 100% safe. The splitting process happens directly in your browser. Your files are never uploaded to our servers, ensuring total privacy.</p>
              </div>
              <div className="w-full h-px bg-white/5"></div>
              <div>
                <h4 className="text-lg font-bold text-white mb-2">Are there any file size limits?</h4>
                <p className="text-neutral-400">No, since processing is done locally, there are no file size limits or paywalls.</p>
              </div>
            </div>
          </div>
        </div>
