        ...
        <div className="mt-24 space-y-16 px-4">
          <div className="text-center space-y-6 max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-black italic uppercase tracking-tighter text-white">
              Why Use the Letter Generator?
            </h2>
            <p className="text-neutral-400 font-medium leading-relaxed">
              Drafting offer letters from scratch is tedious. This tool automates the boilerplate, generating professional PDFs in seconds.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="p-6 rounded-2xl bg-neutral-900/40 border border-white/5 space-y-4">
              ...
              <p className="text-sm text-neutral-400">Instant, printable documents.</p>
            </div>
            <div className="p-6 rounded-2xl bg-neutral-900/40 border border-white/5 space-y-4">
              <div className="h-12 w-12 rounded-full bg-red-600/10 flex items-center justify-center border border-red-600/20">
              ...
              <p className="text-sm text-neutral-400">Add salary, roles, and dates.</p>
            </div>
            <div className="p-6 rounded-2xl bg-neutral-900/40 border border-white/5 space-y-4">
              <div className="h-12 w-12 rounded-full bg-red-600/10 flex items-center justify-center border border-red-600/20">
              ...
              <p className="text-sm text-neutral-400">Clean corporate formatting.</p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-8 mt-16 p-8 rounded-3xl bg-neutral-900/20 border border-white/10">
            ...
            <div className="space-y-6">
              <div>
                <h4 className="text-lg font-bold text-white mb-2">Is this legal to use?</h4>
                <p className="text-neutral-400">This tool is meant for educational purposes, HR templates, or mock interviews. Do not use it to commit fraud.</p>
              </div>
              <div className="w-full h-px bg-white/5"></div>
              <div>
                <h4 className="text-lg font-bold text-white mb-2">Can I export to PDF?</h4>
                <p className="text-neutral-400">Yes, the letter is generated as a high-quality, printable PDF document.</p>
              </div>
              <div className="w-full h-px bg-white/5"></div>
              <div>
                <h4 className="text-lg font-bold text-white mb-2">Can I add a company logo?</h4>
                <p className="text-neutral-400">Yes, you can upload a logo which will be embedded into the letterhead.</p>
              </div>
            </div>
          </div>
        </div>
