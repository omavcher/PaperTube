        ...
        <div className="mt-24 space-y-16 px-4">
          <div className="text-center space-y-6 max-w-3xl mx-auto">
            ...
            <p className="text-neutral-400 font-medium leading-relaxed">
              Weak passwords are the leading cause of data breaches. Our tool instantly generates uncrackable secrets right on your device.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="p-6 rounded-2xl bg-neutral-900/40 border border-white/5 space-y-4">
              ...
              <h3 className="text-xl font-bold text-white">Client-Side Safe</h3>
              <p className="text-sm text-neutral-400">Zero risk of interception.</p>
            </div>
            <div className="p-6 rounded-2xl bg-neutral-900/40 border border-white/5 space-y-4">
              <div className="h-12 w-12 rounded-full bg-red-600/10 flex items-center justify-center border border-red-600/20">
                <span className="text-red-500 font-bold">2</span>
              </div>
              <h3 className="text-xl font-bold text-white">Highly Customizable</h3>
              <p className="text-sm text-neutral-400">Match any password policy.</p>
            </div>
            <div className="p-6 rounded-2xl bg-neutral-900/40 border border-white/5 space-y-4">
              <div className="h-12 w-12 rounded-full bg-red-600/10 flex items-center justify-center border border-red-600/20">
                <span className="text-red-500 font-bold">3</span>
              </div>
              <h3 className="text-xl font-bold text-white">Instant Copy</h3>
              <p className="text-sm text-neutral-400">One-click copy to clipboard.</p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-8 mt-16 p-8 rounded-3xl bg-neutral-900/20 border border-white/10">
            ...
            <div className="space-y-6">
              <div>
                <h4 className="text-lg font-bold text-white mb-2">Are these passwords secure?</h4>
                <p className="text-neutral-400">Yes, they are generated using cryptographically secure random number generators in your browser.</p>
              </div>
              <div className="w-full h-px bg-white/5"></div>
              <div>
                <h4 className="text-lg font-bold text-white mb-2">Do you store the passwords?</h4>
                <p className="text-neutral-400">No! The passwords never leave your device. We have no backend server collecting them.</p>
              </div>
              <div className="w-full h-px bg-white/5"></div>
              <div>
                <h4 className="text-lg font-bold text-white mb-2">Can I include special characters?</h4>
                <p className="text-neutral-400">Yes, you can toggle uppercase, lowercase, numbers, and symbols to meet strict security requirements.</p>
              </div>
            </div>
          </div>
        </div>
