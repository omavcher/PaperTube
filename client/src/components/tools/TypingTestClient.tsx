        ...
        <div className="mt-24 space-y-16 px-4">
          <div className="text-center space-y-6 max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-black italic uppercase tracking-tighter text-white">
              Why Take Our Typing Test?
            </h2>
            <p className="text-neutral-400 font-medium leading-relaxed">
              A faster typing speed boosts productivity. Our test provides an elegant, distraction-free interface to measure and improve your WPM.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="p-6 rounded-2xl bg-neutral-900/40 border border-white/5 space-y-4">
              ...
              <h3 className="text-xl font-bold text-white">Precision Metrics</h3>
              <p className="text-sm text-neutral-400">Accurate to the millisecond.</p>
            </div>
            <div className="p-6 rounded-2xl bg-neutral-900/40 border border-white/5 space-y-4">
              <div className="h-12 w-12 rounded-full bg-red-600/10 flex items-center justify-center border border-red-600/20">
                <span className="text-red-500 font-bold">2</span>
              </div>
              <h3 className="text-xl font-bold text-white">Code Mode</h3>
              <p className="text-sm text-neutral-400">Practice syntax-heavy typing.</p>
            </div>
            <div className="p-6 rounded-2xl bg-neutral-900/40 border border-white/5 space-y-4">
              <div className="h-12 w-12 rounded-full bg-red-600/10 flex items-center justify-center border border-red-600/20">
                <span className="text-red-500 font-bold">3</span>
              </div>
              <h3 className="text-xl font-bold text-white">Beautiful UI</h3>
              <p className="text-sm text-neutral-400">Distraction-free focus environment.</p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-8 mt-16 p-8 rounded-3xl bg-neutral-900/20 border border-white/10">
            ...
            <div className="space-y-6">
              <div>
                <h4 className="text-lg font-bold text-white mb-2">How is WPM calculated?</h4>
                <p className="text-neutral-400">Words Per Minute is calculated based on the standard 5 characters per word formula, factoring in accuracy.</p>
              </div>
              <div className="w-full h-px bg-white/5"></div>
              <div>
                <h4 className="text-lg font-bold text-white mb-2">Is it meant for programmers?</h4>
                <p className="text-neutral-400">Yes, we include code-specific typing tests to help developers improve their punctuation speed.</p>
              </div>
              <div className="w-full h-px bg-white/5"></div>
              <div>
                <h4 className="text-lg font-bold text-white mb-2">Can I track my progress?</h4>
                <p className="text-neutral-400">You can see your real-time stats including raw WPM, accuracy percentage, and error count.</p>
              </div>
            </div>
          </div>
        </div>
