        ...
        <div className="mt-24 space-y-16 px-4">
          <div className="text-center space-y-6 max-w-3xl mx-auto">
            ...
            <p className="text-neutral-400 font-medium leading-relaxed">
              Planning your finances should be easy. Our tool provides an instant, visual breakdown of your loan repayment schedule.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="p-6 rounded-2xl bg-neutral-900/40 border border-white/5 space-y-4">
              ...
              <h3 className="text-xl font-bold text-white">Accurate Math</h3>
              <p className="text-sm text-neutral-400">Uses standard banking algorithms.</p>
            </div>
            <div className="p-6 rounded-2xl bg-neutral-900/40 border border-white/5 space-y-4">
              <div className="h-12 w-12 rounded-full bg-red-600/10 flex items-center justify-center border border-red-600/20">
                <span className="text-red-500 font-bold">2</span>
              </div>
              <h3 className="text-xl font-bold text-white">Visual Charts</h3>
              <p className="text-sm text-neutral-400">See interest vs principal breakdown.</p>
            </div>
            <div className="p-6 rounded-2xl bg-neutral-900/40 border border-white/5 space-y-4">
              <div className="h-12 w-12 rounded-full bg-red-600/10 flex items-center justify-center border border-red-600/20">
              ...
              <p className="text-sm text-neutral-400">Recalculates as you slide the inputs.</p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-8 mt-16 p-8 rounded-3xl bg-neutral-900/20 border border-white/10">
            ...
            <div className="space-y-6">
              <div>
                <h4 className="text-lg font-bold text-white mb-2">How is EMI calculated?</h4>
                <p className="text-neutral-400">EMI is calculated based on the principal loan amount, interest rate, and loan tenure using standard banking formulas.</p>
              </div>
              <div className="w-full h-px bg-white/5"></div>
              <div>
                <h4 className="text-lg font-bold text-white mb-2">Can I use it for home and car loans?</h4>
                <p className="text-neutral-400">Yes, you can calculate EMI for any type of loan by adjusting the interest rate and tenure.</p>
              </div>
              <div className="w-full h-px bg-white/5"></div>
              <div>
                <h4 className="text-lg font-bold text-white mb-2">Does it show an amortization schedule?</h4>
                <p className="text-neutral-400">Yes, it breaks down your monthly payments into principal and interest components over time.</p>
              </div>
            </div>
          </div>
        </div>
