        ...
        <div className="mt-24 space-y-16 px-4">
          <div className="text-center space-y-6 max-w-3xl mx-auto">
            ...
            <p className="text-neutral-400 font-medium leading-relaxed">
              Our tool uses modern web APIs to process images directly on your device, making it much faster and more secure than cloud-based converters.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="p-6 rounded-2xl bg-neutral-900/40 border border-white/5 space-y-4">
              ...
              <h3 className="text-xl font-bold text-white">Zero Uploads</h3>
              <p className="text-sm text-neutral-400">Total privacy and instant processing.</p>
            </div>
            <div className="p-6 rounded-2xl bg-neutral-900/40 border border-white/5 space-y-4">
              <div className="h-12 w-12 rounded-full bg-red-600/10 flex items-center justify-center border border-red-600/20">
                <span className="text-red-500 font-bold">2</span>
              </div>
              <h3 className="text-xl font-bold text-white">Multiple Formats</h3>
              <p className="text-sm text-neutral-400">Supports PNG, JPG, and WEBP.</p>
            </div>
            <div className="p-6 rounded-2xl bg-neutral-900/40 border border-white/5 space-y-4">
              <div className="h-12 w-12 rounded-full bg-red-600/10 flex items-center justify-center border border-red-600/20">
              ...
              <p className="text-sm text-neutral-400">Maintains original image resolution.</p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-8 mt-16 p-8 rounded-3xl bg-neutral-900/20 border border-white/10">
            ...
            <div className="space-y-6">
              <div>
                <h4 className="text-lg font-bold text-white mb-2">Does it support WEBP conversion?</h4>
                <p className="text-neutral-400">Yes, you can easily convert modern WEBP images into PNG or JPG, or vice-versa.</p>
              </div>
              <div className="w-full h-px bg-white/5"></div>
              <div>
                <h4 className="text-lg font-bold text-white mb-2">Is there a file upload limit?</h4>
                <p className="text-neutral-400">No limits! All processing is done locally in your browser, so you can convert large files without limits.</p>
              </div>
              <div className="w-full h-px bg-white/5"></div>
              <div>
                <h4 className="text-lg font-bold text-white mb-2">Are my images uploaded to a server?</h4>
                <p className="text-neutral-400">No, your images never leave your device, ensuring total privacy.</p>
              </div>
            </div>
          </div>
        </div>
