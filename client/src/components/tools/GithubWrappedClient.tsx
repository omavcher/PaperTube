...
export default function GithubWrappedClient() {
  const [username, setUsername] = useState("");
  const [userData, setUserData] = useState<any>(null);
  const [isScanning, setIsScanning] = useState(false);
  const exportRef = useRef<HTMLDivElement>(null);
  
  useToolAnalytics("github-wrapped", "WRAPPED", "Engineering Tools");
    ...
    <div className="min-h-screen bg-[#000000] text-white selection:bg-red-500/30 font-sans relative overflow-hidden flex flex-col">
      ...
      <header className="relative z-50 border-b border-white/5 bg-black/60 backdrop-blur-xl px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          {userData && (
            <Button onClick={handleExport} className="bg-red-600 hover:bg-red-700 text-white font-black uppercase italic rounded-xl px-8 h-10 shadow-[0_0_30px_rgba(220,38,38,0.2)] text-xs">
              ...
              <div className="relative z-10 grid lg:grid-cols-12 gap-20">
                ...
                <div className="lg:col-span-4 space-y-10">
                   <div className="relative w-fit">
                      ...
                      <img src={userData.avatar_url} className="h-48 w-48 rounded-3xl border-4 border-red-600 relative z-10 shadow-2xl" alt="Profile" />
