        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="group relative bg-neutral-900/40 border border-white/5 rounded-[1.25rem] md:rounded-[2.5rem] p-4 md:p-8 transition-all duration-300 hover:bg-neutral-900/60 hover:border-white/10 hover:shadow-2xl overflow-hidden transform-gpu"
            >
