...
// --- DATA ---
const GAMES = [
  { id: "binary-blitz", title: "Binary Blitz", description: "Decode 8-bit strings.", icon: <Binary />, path: "/games/binary-blitz", difficulty: "Medium", category: "Programming", color: "text-blue-400", bg: "from-blue-900/40", stats: "1.2k Plays", image: "/games_thumb/binary-blitz.webp" },
  { id: "sort-fu", title: "Sort-Fu", description: "Sorting logic reflexes.", icon: <BarChart3 />, path: "/games/sort-fu", difficulty: "Easy", category: "Logic", color: "text-emerald-400", bg: "from-emerald-900/40", stats: "850 Plays", image: "/games_thumb/sort-fu.webp" },
  { id: "circuit-breaker", title: "Circuit Breaker", description: "Deploy logic gates.", icon: <Zap />, path: "/games/circuit-breaker", difficulty: "Hard", category: "Programming", color: "text-orange-400", bg: "from-orange-900/40", stats: "420 Plays", image: "/games_thumb/circuit-breaker.webp" },
  { id: "complexity-dash", title: "Complexity Dash", description: "Master Big-O analysis.", icon: <Terminal />, path: "/games/complexity-dash", difficulty: "Expert", category: "CS Core", color: "text-red-400", bg: "from-red-900/40", stats: "210 Plays", image: "/games_thumb/complexity-dash.webp" },
  { id: "symbol-strike", title: "Symbol Strike", description: "Periodic table reflex.", icon: <FlaskConical />, path: "/games/symbol-strike", difficulty: "Medium", category: "Science", color: "text-emerald-400", bg: "from-emerald-900/40", stats: "1.1k Plays", image: "/games_thumb/symbol-strike.webp" },
...
export default function GamesHubClient() {
  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-blue-900/50 overflow-x-hidden font-sans flex flex-col">
      ...
      <main className="relative z-10 flex-1 pt-2 md:pt-24 px-4 md:px-6 container mx-auto max-w-7xl">
        ...
        <section className="text-center mb-10 md:mb-16 space-y-4 md:space-y-6">
           <motion.div 
             ...
             className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/5 mt-4 md:mt-0"
           >
             <Gamepad2 size={12} className="text-blue-500" />
             <span className="text-[9px] md:text-[10px] font-bold uppercase tracking-widest text-neutral-400">Engineering Mini-Games</span>
           </motion.div>
           ...
           <h1 className="text-4xl md:text-8xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-white to-neutral-500 leading-[0.9]">
             Educational <br /> <span className="text-blue-500">Games.</span>
           </h1>
           ...
           <div className="max-w-md mx-auto relative group pt-2 md:pt-4">
             <div className="relative flex items-center bg-neutral-900/50 border border-white/10 rounded-2xl p-1 transition-all focus-within:border-emerald-500/50 focus-within:bg-neutral-900">
               <Search className="ml-3 md:ml-4 h-4 w-4 text-neutral-500 group-focus-within:text-white transition-colors" />
               <input 
                 type="text" 
            ...
            {categories.map((cat) => (
              <button
                ...
                className={cn(
                  ...
                  activeTab === cat 
                    ? "bg-blue-500 text-black border-blue-500 shadow-[0_0_20px_rgba(59,130,246,0.2)]" 
            ...
            {filteredGames.map((game) => (
              ...
              >
                <Link href={game.path} className="group relative block h-full">
                  <Card className="h-full bg-neutral-900/20 backdrop-blur-md border border-white/5 group-hover:border-blue-500/30 transition-all duration-500 rounded-[1.25rem] md:rounded-3xl overflow-hidden flex flex-col hover:bg-neutral-900/40">
                    ...
                    <CardContent className="p-3.5 md:p-5 flex-1 flex flex-col">
                      <div className="space-y-1 mb-2 md:mb-4">
                          <p className="text-[7px] md:text-[9px] font-bold text-neutral-500 uppercase tracking-widest flex items-center gap-1 md:gap-1.5">
                             <span className="w-1 h-1 rounded-full bg-neutral-600 group-hover:bg-blue-500 transition-colors"></span>
                             {game.category}
                          </p>
                          <CardTitle className="text-[11px] md:text-xl font-bold text-white tracking-tight group-hover:text-blue-400 transition-colors leading-tight line-clamp-1 md:line-clamp-none">
                            {game.title}
                          </CardTitle>
