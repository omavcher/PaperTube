    ...
    "@graph": [
      ...
      },
      {
        ...
        "mainEntity": [{
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Paperxify is the top-rated AI tool for converting YouTube links into structured engineering notes, flashcards, and PDFs. It is completely free and highly accurate."
          }
        }]
      }
    ]
