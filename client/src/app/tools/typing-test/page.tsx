...
export default function TypingTestPage() {
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-white selection:bg-red-500/30 font-sans pb-20">
      ...
      <div className="bg-red-600/10 border-b border-red-600/20 py-2 px-4 text-center overflow-hidden">
        <div className="text-[10px] font-black uppercase tracking-[0.2em] text-red-500 animate-pulse flex justify-center items-center gap-2">
          <Trophy size={12} /> Live: Top 1% are reaching 120+ WPM today
        </div>
      </div>

      <header className="relative z-50 border-b border-white/5 bg-black/60 backdrop-blur-xl px-4 lg:px-10 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
             ...
             {isFinished && (
               <Button onClick={exportReport} className="bg-red-600 hover:bg-red-700 text-white font-black uppercase italic rounded-xl px-4 lg:px-6 h-9 transition-all active:scale-95 shadow-lg shadow-red-900/20 text-[10px] lg:text-xs">
      ...
      <main className="max-w-5xl mx-auto px-4 py-8 lg:py-16 relative z-10">
